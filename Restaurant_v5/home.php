      ...
      <div class="tab-content">
        ...
        <div id="menu4" class="tab-pane fade">
            ...
            <div class="tab-content">
                ...
                <div class="col-sm-6">
                    ...
                    <img src="american_pizza.jpg" alt="american_pizza" style="width: 75%;">
                </div>
                <div class="col-sm-6">
                    <div>Vegan pizza</div>
                ...
                <div class="col-sm-6">
                    ...
                    <img src="vegetarian_pizza.jpg" alt="vegetarian_pizza" style="width: 75%;">
                </div>
                <div class="col-sm-6">
                    <div>Calzone</div>
        ...
        <div id="menu5" class="tab-pane fade">
            ...
            <div class="tab-content">
                ...
                <div class="col-sm-6">
                    <div>waffles</div>
                    <img src="waffles.jpg" alt="waffles" style="width: 75%;">
                </div>
                </div>
              </div>
        </div>
        <div id="menu6" class="tab-pane fade">
            ...
            <div class="tab-content">
                ...
                <div class="col-sm-6">
                    <div>Coca Cola</div>
                    <img src="coca_cola.jpg" alt="coca_cola" style="width: 75%;">
                </div>
                </div>
              </div>
        </div>
